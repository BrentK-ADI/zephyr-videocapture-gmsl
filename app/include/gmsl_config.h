...
static const struct gmsl_reg ser_max96717_init[] = {
    /* GPIO Configuration */
    {0x02C4, 0x90}, // MFP2: Always high (IMX_Module nReset)
...
#if CONFIG_GMSL_DESER_DUPLICATE
    /* MIPI D-PHY Configuration */
    {0x094A, 0x50}, // MIPI_TX10: Port A Lane Count: 2
    {0x08A3, 0xE4}, // MIPI_PHY3: PHY1 D0=Lane0, D1=Lane1, PHY3 D0=Lane2, D1=Lane3
    {0x08A5, 0x00}, // MIPI_PHY5: PHY0/PHY1 Polarity Normal
    {0x0943, 0x07}, // MIPI_TX3: Controller 1 Auto Initial Deskew Disabled
    {0x0944, 0x01}, // MIPI_TX4: Controller 1 Periodic Deskew Disabled
#endif
...
#if CONFIG_GMSL_DESER_DUPLICATE
    /* CSI Clock Configuration (~1000MHz per lane) */
    {0x0418, 0x2A}, // BACKTOP: CSI clock ~1000MHz per lane
    {0x08A2, 0xF4}, // MIPI_PHY2: All PHYs enabled
#else
    {0x08A2, 0xC4}, // MIPI_PHY2: PHY0 and PHY1 in standby
#endif

    /* Tunnel Mode Configuration */
    {0x08CA, 0xE6}, // MIPI_CTRL_SEL: Pipe 0 Controller = 0x2, Pipe 1 Controller = 1
...
#if CONFIG_GMSL_DESER_DUPLICATE
    {0x040B, 0x03}, // BACKTOP12: CSI output Port A and B enabled
    {0x08A9, 0xB0}, // PHYCOPY 2 to 1
#else
    {0x040B, 0x02}, // BACKTOP12: CSI output Port B enabled
#endif
};
